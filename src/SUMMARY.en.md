...
11. [The elements of HTML](the-elements-of-html/index.en.html)
  ...
  data-x="rel-preload">preload</code></dfn>"](the-elements-of-html/links/link-types/link-type-preload.en.html)
      20. [Link type "<dfn><code data-x="rel-prerender">prerender</code></dfn>"](the-elements-of-html/links/link-types/link-type-prerender.en.html)
  ...
  14. [Common idioms without dedicated elements](the-elements-of-html/common-idioms-without-dedicated-elements/index.en.html)
    ...
    2. [Tag clouds](the-elements-of-html/common-idioms-without-dedicated-elements/tag-clouds.en.html)
...
13. [<dfn>User interaction</dfn>](user-interaction/index.en.html)
  ...
  5. [Focus](user-interaction/focus/index.en.html)
    ...
    7. [<span id="autofocusing-a-form-control:-the-autofocus-attribute"></span>The <code
...
14. [Loading web pages](loading-web-pages/index.en.html)
  ...
  5. [Origin](loading-web-pages/origin/index.en.html)
    ...
    3. [Origin isolation](loading-web-pages/origin/origin-isolation.en.html)
  ...
  content that doesn't have a DOM</dfn>](loading-web-pages/browsing-the-web/page-load-processing-model-for-inline-content-that-doesnt-have-a-dom.en.html)
    ...
    10. [History traversal](loading-web-pages/browsing-the-web/history-traversal/index.en.html)
      1. [Persisted history entry state](loading-web-pages/browsing-the-web/history-traversal/persisted-history-entry-state.en.html)
...
15. [Web application APIs](web-application-apis/index.en.html)
  1. [Scripting](web-application-apis/scripting/index.en.html)
    ...
    3. [Realms and their counterparts](web-application-apis/scripting/realms-and-their-counterparts/index.en.html)
      ...
      3. [Realms, settings objects, and global objects](web-application-apis/scripting/realms-and-their-counterparts/realms-settings-objects-and-global-objects/index.en.html)
        ...
        2. [Incumbent](web-application-apis/scripting/realms-and-their-counterparts/realms-settings-objects-and-global-objects/incumbent.en.html)
  ...
  <var>specifier</var>, <var>promiseCapability</var>)](web-application-apis/scripting/javascript-specification-host-hooks/module-related-host-hooks/hostimportmoduledynamically-referencingscriptormodule-specifier-promisecapability.en.html)
        3. [<dfn>HostResolveImportedModule</dfn>(<var>referencingScriptOrModule</var>,
  <var>specifier</var>)](web-application-apis/scripting/javascript-specification-host-hooks/module-related-host-hooks/hostresolveimportedmodule-referencingscriptormodule-specifier.en.html)
    6. [Event loops](web-application-apis/scripting/event-loops/index.en.html)
      1. [Definitions](web-application-apis/scripting/event-loops/definitions.en.html)
      2. [Queuing tasks](web-application-apis/scripting/event-loops/queuing-tasks.en.html)
      3. [<span
  id="processing-model-8"></span>Processing model](web-application-apis/scripting/event-loops/processing-model.en.html)
      4. [Generic task sources](web-application-apis/scripting/event-loops/generic-task-sources.en.html)
      5. [Dealing with the event loop from other specifications](web-application-apis/scripting/event-loops/dealing-with-the-event-loop-from-other-specifications.en.html)
    7. [Events](web-application-apis/scripting/events/index.en.html)
  ...
  4. [<dfn>Dynamic markup insertion</dfn>](web-application-apis/dynamic-markup-insertion/index.en.html)
    ...
    5. [Parsing HTML or XML documents](web-application-apis/dynamic-markup-insertion/parsing-html-or-xml-documents.en.html)
  5. [DOM parsing](web-application-apis/dom-parsing.en.html)
  6. [Timers](web-application-apis/timers.en.html)
  7. [Microtask queuing](web-application-apis/microtask-queuing.en.html)
  8. [User prompts](web-application-apis/user-prompts/index.en.html)
  ...
  9. [System state and capabilities](web-application-apis/system-state-and-capabilities/index.en.html)
  ...
  10. [Images](web-application-apis/images.en.html)
  11. [Animation frames](web-application-apis/animation-frames.en.html)
...
18. [Worklets](worklets/index.en.html)
  1. [Introduction](worklets/introduction/index.en.html)
    1. [Motivations](worklets/introduction/motivations.en.html)
    2. [Code idempotence](worklets/introduction/code-idempotence.en.html)
    3. [Speculative evaluation](worklets/introduction/speculative-evaluation.en.html)
  2. [Examples](worklets/examples/index.en.html)
    1. [Loading scripts](worklets/examples/loading-scripts.en.html)
    2. [Registering a class and invoking its methods](worklets/examples/registering-a-class-and-invoking-its-methods.en.html)
  3. [Infrastructure](worklets/infrastructure/index.en.html)
    1. [The global scope](worklets/infrastructure/the-global-scope/index.en.html)
      1. [Agents and event loops](worklets/infrastructure/the-global-scope/agents-and-event-loops.en.html)
      2. [Creation and termination](worklets/infrastructure/the-global-scope/creation-and-termination.en.html)
      3. [Script settings for worklets](worklets/infrastructure/the-global-scope/script-settings-for-worklets.en.html)
    2. [The <code>Worklet</code> class](worklets/infrastructure/the-worklet-class.en.html)
    3. [The worklet's lifetime](worklets/infrastructure/the-worklets-lifetime.en.html)
19. [Web storage](web-storage/index.en.html)
  ...
  2. [The API](web-storage/the-api/index.en.html)
    ...
    2. [The <code data-x="dom-sessionStorage">sessionStorage</code> getter](web-storage/the-api/the-sessionstorage-getter.en.html)
    3. [The <code data-x="dom-localStorage">localStorage</code> getter](web-storage/the-api/the-localstorage-getter.en.html)
    4. [The <code>StorageEvent</code> interface](web-storage/the-api/the-storageevent-interface.en.html)
  3. [Privacy](web-storage/privacy/index.en.html)
  ...
  4. [Security](web-storage/security/index.en.html)
...
20. [<dfn>The HTML syntax</dfn>](the-html-syntax/index.en.html)
  ...
  2. [Parsing HTML documents](the-html-syntax/parsing-html-documents/index.en.html)
    ...
    5. [<dfn>Tokenization</dfn>](the-html-syntax/parsing-html-documents/tokenization/index.en.html)
      ...
      76. [<dfn>Hexadecimal character reference start state</dfn>](the-html-syntax/parsing-html-documents/tokenization/hexadecimal-character-reference-start-state.en.html)
      ...
      78. [<dfn>Hexadecimal character reference state</dfn>](the-html-syntax/parsing-html-documents/tokenization/hexadecimal-character-reference-state.en.html)
...
21. [<dfn id="xhtml">The XML syntax</dfn>](the-xml-syntax/index.en.html)
...
22. [Rendering](rendering/index.en.html)
  ...
  3. [Non-replaced elements](rendering/non-replaced-elements/index.en.html)
    ...
    6. [Sections and headings](rendering/non-replaced-elements/sections-and-headings.en.html)
    7. [Lists](rendering/non-replaced-elements/lists.en.html)
    8. [Tables](rendering/non-replaced-elements/tables.en.html)
    9. [Margin collapsing quirks](rendering/non-replaced-elements/margin-collapsing-quirks.en.html)
    10. [Form controls](rendering/non-replaced-elements/form-controls.en.html)
    11. [The <code>hr</code> element](rendering/non-replaced-elements/the-hr-element.en.html)
    12. [The <code>fieldset</code> and <code>legend</code> elements](rendering/non-replaced-elements/the-fieldset-and-legend-elements.en.html)
  ...
  5. [<span id="bindings"></span>Widgets](rendering/widgets/index.en.html)
    ...
    2. [Button layout](rendering/widgets/button-layout.en.html)
    3. [The <code>button</code> element](rendering/widgets/the-button-element.en.html)
    4. [The <code>details</code> and <code>summary</code> elements](rendering/widgets/the-details-and-summary-elements.en.html)
    5. [The <code>input</code> element as a text entry widget](rendering/widgets/the-input-element-as-a-text-entry-widget.en.html)
    6. [The <code>input</code> element as domain-specific widgets](rendering/widgets/the-input-element-as-domain-specific-widgets.en.html)
    7. [The <code>input</code> element as a range control](rendering/widgets/the-input-element-as-a-range-control.en.html)
    8. [The <code>input</code> element as a color
  well](rendering/widgets/the-input-element-as-a-color-well.en.html)
    9. [The <code>input</code> element as a checkbox and radio button widgets](rendering/widgets/the-input-element-as-a-checkbox-and-radio-button-widgets.en.html)
    10. [The <code>input</code> element as a file upload control](rendering/widgets/the-input-element-as-a-file-upload-control.en.html)
    11. [The <code>input</code> element as a button](rendering/widgets/the-input-element-as-a-button.en.html)
    12. [The <code>marquee</code> element](rendering/widgets/the-marquee-element.en.html)
    13. [The <code>meter</code> element](rendering/widgets/the-meter-element.en.html)
    14. [The <code>progress</code> element](rendering/widgets/the-progress-element.en.html)
    15. [The <code>select</code> element](rendering/widgets/the-select-element.en.html)
    16. [The <code>textarea</code> element](rendering/widgets/the-textarea-element.en.html)
...
23. [Obsolete features](obsolete-features/index.en.html)
...
24. [IANA considerations](iana-considerations/index.en.html)
  ...
  8. [`<dfn http-header><code>Cross-Origin-Embedder-Policy</code></dfn>`](iana-considerations/cross-origin-embedder-policy.en.html)
  9. [`<dfn http-header><code>Cross-Origin-Embedder-Policy-Report-Only</code></dfn>`](iana-considerations/cross-origin-embedder-policy-report-only.en.html)
  10. [`<dfn http-header><code
  data-x="http-cross-origin-opener-policy">Cross-Origin-Opener-Policy</code></dfn>`](iana-considerations/cross-origin-opener-policy.en.html)
  11. [`<dfn><code data-x="http-origin-isolation">Origin-Isolation</code></dfn>`](iana-considerations/origin-isolation.en.html)
  12. [`<dfn><code data-x="http-ping-from">Ping-From</code></dfn>`](iana-considerations/ping-from.en.html)
  13. [`<dfn><code data-x="http-ping-to">Ping-To</code></dfn>`](iana-considerations/ping-to.en.html)
  14. [`<dfn><code data-x="http-refresh">Refresh</code></dfn>`](iana-considerations/refresh.en.html)
  15. [`<dfn><code data-x="http-last-event-id">Last-Event-ID</code></dfn>`](iana-considerations/last-event-id.en.html)
  16. [`<dfn><code>X-Frame-Options</code></dfn>`](iana-considerations/x-frame-options.en.html)
  17. [<dfn><code data-x="scheme-web">web+</code> scheme prefix</dfn>](iana-considerations/web-scheme-prefix.en.html)
25. [Index](index/index.en.html)
...
26. [References](references.en.html)
27. [Acknowledgments](acknowledgments.en.html)
28. [Intellectual property rights](intellectual-property-rights.en.html)
