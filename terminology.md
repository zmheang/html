术语 | 英文原文 | 建议翻译 | 出处
--- | --- | --- | ---
"all"-named elements | "all"-named elements | "all"-named elements | 2.6.2.1
2D context creation algorithm | 2D context creation algorithm | 2D context creation algorithm | 4.12.5.1
A type that the user agent knows it cannot render | A type that the user agent knows it cannot render | A type that the user agent knows it cannot render | 4.8.12.3
API URL character encoding | API URL character encoding | API URL character encoding | 8.1.3.1
API base URL | API base URL | API base URL | 8.1.3.1
ASCII case-insensitive | ASCII case-insensitive | ASCII case-insensitive | 2.1.8
ASCII digits | ASCII digits | ASCII digits | 2.3.1
...
After DOCTYPE public keyword state | After DOCTYPE public keyword state | After DOCTYPE public keyword state | 12.2.4.57
After DOCTYPE system identifier state | After DOCTYPE system identifier state | After DOCTYPE system identifier state | 12.2.4.67
After DOCTYPE system keyword state | After DOCTYPE system keyword state | After DOCTYPE system keyword state | 12.2.4.63
After attribute name state | After attribute name state | After attribute name state | 12.2.4.34
After attribute value (quoted) state | After attribute value (quoted) state | After attribute value (quoted) state | 12.2.4.39
An entry with persisted user state | An entry with persisted user state | An entry with persisted user state | 7.7.1
An unstyled document view | An unstyled document view | An unstyled document view | 14.9
Attribute name state | Attribute name state | Attribute name state | 12.2.4.33
Attribute value (double-quoted) state | Attribute value (double-quoted) state | Attribute value (double-quoted) state | 12.2.4.36
Attribute value (single-quoted) state | Attribute value (single-quoted) state | Attribute value (single-quoted) state | 12.2.4.37
Attribute value (unquoted) state | Attribute value (unquoted) state | Attribute value (unquoted) state | 12.2.4.38
Attributes for form submission | Attributes for form submission | Attributes for form submission | 4.10.19.6
Autofill detail tokens | Autofill detail tokens | Autofill detail tokens | 4.10.19.8.1
Before DOCTYPE name state | Before DOCTYPE name state | Before DOCTYPE name state | 12.2.4.54
Before DOCTYPE public identifier state | Before DOCTYPE public identifier state | Before DOCTYPE public identifier state | 12.2.4.58
Before DOCTYPE system identifier state | Before DOCTYPE system identifier state | Before DOCTYPE system identifier state | 12.2.4.64
Before attribute name state | Before attribute name state | Before attribute name state | 12.2.4.32
Before attribute value state | Before attribute value state | Before attribute value state | 12.2.4.35
Between DOCTYPE public and system identifiers state | Between DOCTYPE public and system identifiers state | Between DOCTYPE public and system identifiers state | 12.2.4.62
Bogus DOCTYPE state | Bogus DOCTYPE state | Bogus DOCTYPE state | 12.2.4.68
Bogus comment state | Bogus comment state | Bogus comment state | 12.2.4.41
CDATA section bracket state | CDATA section bracket state | CDATA section bracket state | 12.2.4.70
CDATA section end state | CDATA section end state | CDATA section end state | 12.2.4.71
CDATA section state | CDATA section state | CDATA section state | 12.2.4.69
CORS protocol | CORS protocol | CORS protocol | 2.1.8
CORS settings attribute | CORS settings attribute | CORS settings attribute | 2.5.4
CORS-cross-origin | CORS-cross-origin | CORS-cross-origin | 2.5.1
CORS-same-origin | CORS-same-origin | CORS-same-origin | 2.5.1
CSS properties | CSS properties | CSS properties | 2.1
CSS style sheet | CSS style sheets | CSS style sheets | 2.1.8
CSS style sheet set | CSS style sheet set | CSS style sheet set | 2.1.8
CSS style sheet set name | CSS style sheet set name | CSS style sheet set name | 2.1.8
...
Decimal character reference state | Decimal character reference state | Decimal character reference state | 12.2.4.77
...
Is environment settings object a secure context? | Is environment settings object a secure context? | Is environment settings object a secure context? | 2.1.8
...
Script data escaped dash state | Script data escaped dash state | Script data escaped dash state | 12.2.4.21
...
The drag data item type string | The drag data item type string | The drag data item type string | 6.7.2
...
a plausible language | a plausible language | a plausible language | 8.7.1.2
...
array index property name | array index property name | array index property name | 2.1.8
...
browsing context name | browsing context name | browsing context name | 7.1.5
...
collecting the first vCard subproperty | collecting the first vCard subproperty | collecting the first vCard subproperty | 5.3.1.1
...
concept-appcache-newer | newer | newer | 7.9.2
...
concept-document-content-type | content type | content type | 2.1.8
...
concept-frag-parse-context | context | context | 12.4
...
concept-meter-high | high boundary | high boundary | 4.10.15
...
concept-range-end | end | end | 2.1.8
...
concept-settings-object-referrer-policy | referrer policy | referrer policy | 8.1.3.1
...
containing block | containing block | containing block | 2.1.8
...
currently focused area of a top-level browsing context | currently focused area of a top-level browsing context | currently focused area of a top-level browsing context | 6.4.2
...
dispatch the event | dispatch the event | dispatch the event | 9.2.5
...
enforce the policy | enforce the policy | enforce the policy | 2.1.8
...
fetch a classic worker script | fetch a classic worker script | fetch a classic worker script | 8.1.3.2
...
img-error | Broken | Broken | 4.8.4.3
...
insertion mode: text | text | text | 12.2.5.4.8
...
limited to only non-negative numbers greater than zero | limited to only non-negative numbers greater than zero | limited to only non-negative numbers greater than zero | 2.6.1
...
marquee scroll interval | marquee scroll interval | marquee scroll interval | 15.3.2
...
navigate-ua-inline | Page load processing model for inline content that doesn't have a DOM | Page load processing model for inline content that doesn't have a DOM | 7.8.8
...
original insertion mode | original insertion mode | original insertion mode | 12.2.3.1
...
parse a sandboxing directive | parse a sandboxing directive | parse a sandboxing directive | 7.6
parse a serialized Content Security Policy | parse a serialized Content Security Policy | parse a serialized Content Security Policy | 2.1.8
parse a sizes attribute | parse a sizes attribute | parse a sizes attribute | 4.8.4.3.8
parse a srcset attribute | parse a srcset attribute | parse a srcset attribute | 4.8.4.3.7
parse a time component | parse a time component | parse a time component | 2.3.5.4
parse a time string | parse a time string | parse a time string | 2.3.5.4
parse a time-zone offset component | parse a time-zone offset component | parse a time-zone offset component | 2.3.5.6
parse a time-zone offset string | parse a time-zone offset string | parse a time-zone offset string | 2.3.5.6
parse a week string | parse a week string | parse a week string | 2.3.5.8
parse a yearless date component | parse a yearless date component | parse a yearless date component | 2.3.5.3
parse a yearless date string | parse a yearless date string | parse a yearless date string | 2.3.5.3
parse error | parse errors | parse errors | 12.2
parse something according to a CSS grammar | parsed according to a particular CSS grammar | parsed according to a particular CSS grammar | 2.1.8
parsed as a CSS <color> value | parsed as a CSS <color> value | parsed as a CSS <color> value | 2.1.8
parser pause flag | parser pause flag | parser pause flag | 12.2.1
past names map | past names map | past names map | 4.10.3
path start state | path start state | path start state | 2.1.8
pause | pause | pause | 8.1.4.2
paused for in-band content | paused for in-band content | paused for in-band content | 4.8.12.8
paused for user interaction | paused for user interaction | paused for user interaction | 4.8.12.8
pending application cache download process tasks | pending application cache download process tasks | pending application cache download process tasks | 7.9.4
pending dialog stack | pending dialog stack | pending dialog stack | 4.11.7
pending parsing-blocking script | pending parsing-blocking script | pending parsing-blocking script | 4.12.1.1
pending request | pending request | pending request | 4.8.4.3
pending text track change notification flag | pending text track change notification flag | pending text track change notification flag | 4.8.12.11.1
perform a microtask checkpoint | perform a microtask checkpoint | perform a microtask checkpoint | 8.1.4.2
perform a security check | perform a security check | perform a security check | 2.1.8
perform automatic text track selection | perform automatic text track selection | perform automatic text track selection | 4.8.12.11.3
performing a microtask checkpoint | performing a microtask checkpoint | performing a microtask checkpoint | 8.1.4.1
permissible worker | permissible worker | permissible worker | 10.2.3
picking an encoding for the form | pick an encoding for a form | pick an encoding for a form | 4.10.22.5
pixel density descriptor | pixel density descriptor | pixel density descriptor | 4.8.4.2.1
pixel density descriptor value | pixel density descriptor value | pixel density descriptor value | 4.8.4.2.1
placeholder label option | placeholder label option | placeholder label option | 4.10.7
plan to navigate | plan to navigate | plan to navigate | 4.10.22.3
planned navigation | planned navigation | planned navigation | 4.10.22.3
platform object | platform object | platform object | 2.1.8
plugin | plugin | plugin | 2.1.5
plugin document | plugin document | plugin document | 7.8.7
pop a ruby level | pop a ruby level | pop a ruby level | 4.5.10
populate the list of pending text tracks | populate the list of pending text tracks | populate the list of pending text tracks | 4.8.12.11.1
popup menu state | popup menu | popup menu | 4.11.3
popup sandboxing flag set | popup sandboxing flag set | popup sandboxing flag set | 7.6
port message queue | port message queue | port message queue | 9.5.3
port state | port state | port state | 2.1.8
posted message task source | posted message task source | posted message task source | 9.4
poster frame | poster frame | poster frame | 4.8.9
potentially playing | potentially playing | potentially playing | 4.8.12.8
pragma-set default language | pragma-set default language | pragma-set default language | 4.2.5.3
pre-insert | pre-insert | pre-insert | 2.1.8
preferred CSS style sheet set name | preferred CSS style sheet set name | preferred CSS style sheet set name | 2.1.8
prefix match | prefix match | prefix match | 2.2
prepare a script | prepare a script | prepare a script | 4.12.1.1
prepare an event | prepare an event | prepare an event | 4.8.12.8
prepare to run a callback | prepare to run a callback | prepare to run a callback | 8.1.3.5.2
prepare to run script | prepare to run script | prepare to run script | 8.1.3.4
prescan a byte stream to determine its encoding | prescan a byte stream to determine its encoding | prescan a byte stream to determine its encoding | 12.2.2.2
presentational hints | presentational hints | presentational hints | 14.2
primary control group | primary control group | primary control group | 6.4.5
print when loaded | print when loaded | print when loaded | 8.6.2
printing steps | printing steps | printing steps | 8.6.2
process a navigate URL scheme | process a navigate URL scheme | process a navigate URL scheme | 7.8.1
process a navigate fetch | process a navigate fetch | process a navigate fetch | 7.8.1
process a navigate response | process a navigate response | process a navigate response | 7.8.1
process response | process response | process response | 2.1.8
process the field | process the field | process the field | 9.2.5
processing the backup element queue | processing the backup element queue | processing the backup element queue | 4.13.6
prod-PCENChar | PCENChar | PCENChar | 4.13.3
prod-PotentialCustomElementName | PotentialCustomElementName | PotentialCustomElementName | 4.13.3
proleptic Gregorian calendar | proleptic Gregorian calendar | proleptic Gregorian calendar | 2.3.5
proleptic-Gregorian date | proleptic-Gregorian date | proleptic-Gregorian date | 2.3.5
prompt to unload a document | prompt to unload a document | prompt to unload a document | 7.8.11
property names | property names | property names | 5.2.3
protected worker | protected worker | protected worker | 10.2.3
proto-URL | proto-URL | proto-URL | 8.7.1.3
pseudo-class | pseudo-class | pseudo-class | 2.1.8
push a ruby annotation | push a ruby annotation | push a ruby annotation | 4.5.10
push a ruby level | push a ruby level | push a ruby level | 4.5.10
push onto the list of active formatting elements | push onto the list of active formatting elements | push onto the list of active formatting elements | 12.2.3.3
query state | query state | query state | 2.1.8
queue a microtask | queued | queued | 8.1.4.2
queue a post-load task | queue a post-load task | queue a post-load task | 7.9.4
queue a progress post-load task | queue a progress post-load task | queue a progress post-load task | 7.9.4
queue a task | queue a task | queue a task | 8.1.4.1
quirks mode | quirks mode | quirks mode | 2.1.8
radio button group | radio button group | radio button group | 4.10.5.1.16
rank | rank | rank | 4.3.6
ready for post-load tasks | ready for post-load tasks | ready for post-load tasks | 12.2.6
realm execution context | realm execution context | realm execution context | 8.1.3.1
receives a set-cookie-string | receives a set-cookie-string | receives a set-cookie-string | 2.1.8
reconstruct the active formatting elements | reconstruct the active formatting elements | reconstruct the active formatting elements | 12.2.3.3
reconsume | reconsume | reconsume | 12.2.4
reestablish the connection | reestablish the connection | reestablish the connection | 9.2.3
referrer policy | referrer policy | referrer policy | 2.1.8
referrer policy attribute | referrer policy attribute | referrer policy attribute | 2.5.5
reflect | reflect | reflect | 2.6.1
reflecting IDL attributes | reflecting IDL attributes | reflecting IDL attributes | 17.4
refused to allow the document to be unloaded | refused to allow the document to be unloaded | refused to allow the document to be unloaded | 7.8.11
reinitialize url | reinitialize url | reinitialize url | 4.6.3
reject pending play promises | reject pending play promises | reject pending play promises | 4.8.12.8
related to an ill-fated port | related to an ill-fated port | related to an ill-fated port | 9.5.3
relationship strings | relationship strings | relationship strings | 5.3.1
relevant application cache | relevant application cache | relevant application cache | 7.9.2
relevant child nodes | relevant child nodes | relevant child nodes | 13.3
relevant mutations | relevant mutations | relevant mutations | 4.8.4.3.2
relevant settings object | relevant settings object | relevant settings object | 8.1.3.5.4
relevant types | relevant types | relevant types | 5.2.2
reload override buffer | reload override buffer | reload override buffer | 3.1
reload override flag | reload override flag | reload override flag | 3.1
reload-triggered navigation | reload-triggered navigation | reload-triggered navigation | 7.8.1
remote event task source | remote event task source | remote event task source | 9.2.3
remove a CSS style sheet | remove a CSS style sheet | remove a CSS style sheet | 2.1.8
rendered legend | rendered legend | rendered legend | 14.3.13
replaced element | replaced element | replaced element | 2.1.8
replacement enabled | replacement enabled | replacement enabled | 7.8.10
report the error | report an error | report an error | 8.1.3.9
report the exception | report an exception | report an exception | 8.1.3.9.1
reported MIME types | reported MIME types | reported MIME types | 8.7.1.5
represented by the collection | represented by the collection | represented by the collection | 2.1.8
represents | represent | represent | 3.2.2
reset the form owner | reset the form owner | reset the form owner | 4.10.18.3
reset the insertion mode appropriately | reset the insertion mode appropriately | reset the insertion mode appropriately | 12.2.3.1
reset the rendering context to its default state | reset the rendering context to its default state | reset the rendering context to its default state | 4.12.5.1.2
resolve a module specifier | resolve a module specifier | resolve a module specifier | 8.1.3.8
resolve pending play promises | resolve pending play promises | resolve pending play promises | 4.8.12.8
resource | resource | resource | 2.1.1
responsible browsing context | responsible browsing context | responsible browsing context | 8.1.3.1
responsible document | responsible document | responsible document | 8.1.3.1
responsible event loop | responsible event loop | responsible event loop | 8.1.3.1
restart the animation | restart the animation | restart the animation | 14.4.2
restore persisted user state | restore persisted user state | restore persisted user state | 7.8.10.1
resulting URL record | resulting URL record | resulting URL record | 2.4.2
resulting URL string | resulting URL string | resulting URL string | 2.4.2
return state | return state | return state | 12.2.4
root | root | root | 2.1.8
row group header | row group header | row group header | 4.9.12.2
row header | row header | row header | 4.9.12.2
rules for constructing the chapter tree from a text track | rules for constructing the chapter tree from a text track | rules for constructing the chapter tree from a text track | 4.8.12.11.6
rules for parsing a hash-name reference | rules for parsing a hash-name reference | rules for parsing a hash-name reference | 2.3.9
rules for parsing a legacy color value | rules for parsing a legacy color value | rules for parsing a legacy color value | 2.3.6
rules for parsing a legacy font size | rules for parsing a legacy font size | rules for parsing a legacy font size | 14.3.4
rules for parsing a list of dimensions | rules for parsing a list of dimensions | rules for parsing a list of dimensions | 2.3.4.7
rules for parsing a list of floating-point numbers | rules for parsing a list of floating-point numbers | rules for parsing a list of floating-point numbers | 2.3.4.6
rules for parsing dimension values | rules for parsing dimension values | rules for parsing dimension values | 2.3.4.4
rules for parsing floating-point number values | rules for parsing floating-point number values | rules for parsing floating-point number values | 2.3.4.3
rules for parsing integers | rules for parsing integers | rules for parsing integers | 2.3.4.1
rules for parsing non-negative integers | rules for parsing non-negative integers | rules for parsing non-negative integers | 2.3.4.2
rules for parsing non-zero dimension values | rules for parsing non-zero dimension values | rules for parsing non-zero dimension values | 2.3.4.5
rules for parsing simple color values | rules for parsing simple color values | rules for parsing simple color values | 2.3.6
rules for serializing simple color values | rules for serializing simple color values | rules for serializing simple color values | 2.3.6
rules for updating the display of WebVTT text tracks | rules for updating the display of WebVTT text tracks | rules for updating the display of WebVTT text tracks | 2.1.8
rules for updating the text track rendering | rules for updating the text track rendering | rules for updating the text track rendering | 4.8.12.11.1
run CSS animations and send events | run CSS animations and send events | run CSS animations and send events | 8.1.4.2
run a classic script | run a classic script | run a classic script | 8.1.3.4
run a module script | run a module script | run a module script | 8.1.3.4
run a worker | run a worker | run a worker | 10.2.4
run the animation frame callbacks | run the animation frame callbacks | run the animation frame callbacks | 8.9
run the fullscreen rendering steps | run the fullscreen rendering steps | run the fullscreen rendering steps | 8.1.4.2
run the global script clean-up jobs | run the global script clean-up jobs | run the global script clean-up jobs | 8.1.3.4
run the resize steps | run the resize steps | run the resize steps | 2.1.8
run the scroll steps | run the scroll steps | run the scroll steps | 2.1.8
run the update intersection observations steps | run the update intersection observations steps | run the update intersection observations steps | 2.1.8
running JavaScript execution context | running JavaScript execution context | running JavaScript execution context | 2.1.8
running script | running script | running script | 8.1.3.4
safelisted scheme | safelisted schemes | safelisted schemes | 8.7.1.3
same origin | same origin | same origin | 7.5
same origin-domain | same origin-domain | same origin-domain | 7.5
sandbox propagates to auxiliary browsing contexts flag | sandbox propagates to auxiliary browsing contexts flag | sandbox propagates to auxiliary browsing contexts flag | 7.6
sandboxed automatic features browsing context flag | sandboxed automatic features browsing context flag | sandboxed automatic features browsing context flag | 7.6
sandboxed auxiliary navigation browsing context flag | sandboxed auxiliary navigation browsing context flag | sandboxed auxiliary navigation browsing context flag | 7.6
sandboxed forms browsing context flag | sandboxed forms browsing context flag | sandboxed forms browsing context flag | 7.6
sandboxed modals flag | sandboxed modals flag | sandboxed modals flag | 7.6
sandboxed navigation browsing context flag | sandboxed navigation browsing context flag | sandboxed navigation browsing context flag | 7.6
sandboxed orientation lock browsing context flag | sandboxed orientation lock browsing context flag | sandboxed orientation lock browsing context flag | 7.6
sandboxed origin browsing context flag | sandboxed origin browsing context flag | sandboxed origin browsing context flag | 7.6
sandboxed plugins browsing context flag | sandboxed plugins browsing context flag | sandboxed plugins browsing context flag | 7.6
sandboxed pointer lock browsing context flag | sandboxed pointer lock browsing context flag | sandboxed pointer lock browsing context flag | 7.6
sandboxed presentation browsing context flag | sandboxed presentation browsing context flag | sandboxed presentation browsing context flag | 7.6
sandboxed scripts browsing context flag | sandboxed scripts browsing context flag | sandboxed scripts browsing context flag | 7.6
sandboxed storage area URLs flag | sandboxed storage area URLs flag | sandboxed storage area URLs flag | 7.6
sandboxed top-level navigation browsing context flag | sandboxed top-level navigation browsing context flag | sandboxed top-level navigation browsing context flag | 7.6
sandboxing flag set | sandboxing flag set | sandboxing flag set | 7.6
scheme start state | scheme start state | scheme start state | 2.1.8
scope-match-algorithm | match service worker registration | match service worker registration | 2.1.8
script documentation | Inline documentation for external scripts | Inline documentation for external scripts | 4.12.1.4
script nesting level | script nesting level | script nesting level | 12.2.1
script-closable | script-closable | script-closable | 7.3.1
script-created parser | script-created parser | script-created parser | 8.4.1
scripting flag | scripting flag | scripting flag | 12.2.3.5
scroll restoration mode | scroll restoration mode | scroll restoration mode | 7.7.1
scroll to the fragment | scroll to the fragment | scroll to the fragment | 7.8.9
sectioning root | sectioning roots | sectioning roots | 4.3.11
secure-context | secure context | secure context | 2.1.8
select an image source | select an image source | select an image source | 4.8.4.3.5
self-closing flag | self-closing flag | self-closing flag | 12.2.4
send a signal | send a signal | send a signal | 7.9.10
send a storage notification | send a storage notification | send a storage notification | 11.2.4
sequential focus navigation order | sequential focus navigation order | sequential focus navigation order | 6.4.5
sequential focus navigation starting point | sequential focus navigation starting point | sequential focus navigation starting point | 6.4.5
sequential navigation search algorithm | sequential navigation search algorithm | sequential navigation search algorithm | 6.4.5
serialization of a color | serialization of a color | serialization of a color | 4.12.5.1.9
serialize an integer | serialize an integer | serialize an integer | 2.1.8
serviceworkercontainer-service-worker-client | service worker client | service worker client | 2.1.8
session history | session history | session history | 7.7.1
session history document visibility change steps | session history document visibility change steps | session history document visibility change steps | 7.8.10
session history entry | session history entry | session history entry | 7.7.1
session history event loop | session history event loop | session history event loop | 7.7.2
session history traversal queue | session history traversal queue | session history traversal queue | 7.7.2
set | ordered set | ordered set | 2.1.8
set of comma-separated tokens | set of comma-separated tokens | set of comma-separated tokens | 2.3.8
set of scripts that will execute as soon as possible | set of scripts that will execute as soon as possible | set of scripts that will execute as soon as possible | 4.12.1.1
set of space-separated tokens | set of space-separated tokens | set of space-separated tokens | 2.3.7
set the current base text | set the current base text | set the current base text | 4.5.10
set the document's address | Setting the document's address | Setting the document's address | 7.8.1
set the frozen base URL | set the frozen base URL | set the frozen base URL | 4.2.3
set the password | set the password | set the password | 2.1.8
set the selection range | set the selection range | set the selection range | 4.10.20
set the username | set the username | set the username | 2.1.8
set the value of a new indexed property | set the value of a new indexed property | set the value of a new indexed property | 2.1.8
set the value of a new named property | set the value of a new named property | set the value of a new named property | 2.1.8
set the value of an existing indexed property | set the value of an existing indexed property | set the value of an existing indexed property | 2.1.8
set the value of an existing named property | set the value of an existing named property | set the value of an existing named property | 2.1.8
set up a browsing context environment settings object | set up a browsing context environment settings object | set up a browsing context environment settings object | 7.1.6
set up a worker environment settings object | set up a worker environment settings object | set up a worker environment settings object | 10.2.6.2
set up the position | set up the position | set up the position | 4.11.7
setting | setting | setting | 2.1.4
settings object | settings object | settings object | 8.1.3.1
shadow root | shadow root | shadow root | 2.1.8
shadow tree | shadow tree | shadow tree | 2.1.8
shadow-including descendant | shadow-including descendant | shadow-including descendant | 2.1.8
shadow-including root | shadow-including root | shadow-including root | 2.1.8
shadow-including tree order | shadow-including tree order | shadow-including tree order | 2.1.8
show poster flag | show poster flag | show poster flag | 4.8.12.6
shown | shown | shown | 2.1
shows caching progress | shows caching progress | shows caching progress | 7.9.4
simple color | simple color | simple color | 2.3.6
sizes attribute | sizes attribute | sizes attribute | 4.8.4.2.2
skip White_Space characters | skip White_Space characters | skip White_Space characters | 2.3.1
skip whitespace | skip whitespace | skip whitespace | 2.3.1
skip-when-determining-incumbent counter | skip-when-determining-incumbent counter | skip-when-determining-incumbent counter | 8.1.3.5.2
slot-name | name | name | 2.1.8
solitary callback microtask | solitary callback microtasks | solitary callback microtasks | 8.1.4.2
source browsing context | source browsing context | source browsing context | 7.8.1
source node | source node | source node | 6.7.5
source set | source set | source set | 4.8.4.3
source size | source size | source size | 4.8.4.3
space character | space characters | space characters | 2.3.1
specified value | specified value | specified value | 2.1.8
spin the event loop | spin the event loop | spin the event loop | 8.1.4.2
split a string on commas | split a string on commas | split a string on commas | 2.3.8
split a string on spaces | split a string on spaces | split a string on spaces | 2.3.7
srcset attribute | srcset attribute | srcset attribute | 4.8.4.2.1
stack | stack | stack | 2.1.8
stack of open elements | stack of open elements | stack of open elements | 12.2.3.2
stack of template insertion modes | stack of template insertion modes | stack of template insertion modes | 12.2.3.1
stack pop | pop | pop | 2.1.8
stack push | push | push | 2.1.8
stall timeout | stall timeout | stall timeout | 4.8.12.5
state object | state object | state object | 7.7.1
statically validate the constraints | statically validate the constraints | statically validate the constraints | 4.10.21.2
steps to expose a media-resource-specific text track | steps to expose a media-resource-specific text track | steps to expose a media-resource-specific text track | 4.8.12.11.2
stop parsing | stops parsing | stops parsing | 12.2.6
stopped due to errors | stopped due to errors | stopped due to errors | 4.8.12.8
strictly split a string | strictly split a string | strictly split a string | 2.3.1
strip and collapse whitespace | strip and collapse whitespace | strip and collapse whitespace | 2.3.1
strip leading and trailing whitespace | strip leading and trailing whitespace | strip leading and trailing whitespace | 2.3.1
strip line breaks | strip line breaks | strip line breaks | 2.3.1
style data | style data | style data | 4.2.6
style sheet ready | style sheet ready | style sheet ready | 4.2.7
submenu label | submenu label | submenu label | 4.11.3
submit-body | Submit as entity body | Submit as entity body | 4.10.22.3
submit-dialog | Submit dialog | Submit dialog | 4.10.22.3
submit-get-action | Get action URL | Get action URL | 4.10.22.3
submit-mailto-body | Mail as body | Mail as body | 4.10.22.3
submit-mailto-headers | Mail with headers | Mail with headers | 4.10.22.3
submit-mutate-action | Mutate action URL | Mutate action URL | 4.10.22.3
suitable sequentially focusable area | suitable sequentially focusable area | suitable sequentially focusable area | 6.4.5
support global identifiers for items | support global identifiers for items | support global identifiers for items | 5.2.2
support named properties | support named properties | support named properties | 2.1.8
supported | supported | supported | 2.1.1
supported property indices | supported property indices | supported property indices | 2.1.8
supported property names | supported property names | supported property names | 2.1.8
suspendable worker | suspendable worker | suspendable worker | 10.2.3
synchronous flag | synchronous flag | synchronous flag | 2.1.8
synchronous section | synchronous section | synchronous section | 8.1.4.2
syntax-ambiguous-ampersand | ambiguous ampersand | ambiguous ampersand | 12.1.4
syntax-attribute-name | Attribute names | Attribute names | 12.1.2.3
syntax-attribute-value | Attribute values | Attribute values | 12.1.2.3
syntax-attributes | Attributes | Attributes | 12.1.2.3
syntax-cdata | CDATA sections | CDATA sections | 12.1.5
syntax-charref | character references | character references | 12.1.4
syntax-comments | Comments | Comments | 12.1.6
syntax-doctype | DOCTYPE | DOCTYPE | 12.1.1
syntax-elements | elements | elements | 12.1.2
syntax-end-tag | End tags | End tags | 12.1.2.2
syntax-newlines | Newlines | Newlines | 12.1.3.1
syntax-start-tag | Start tags | Start tags | 12.1.2.1
syntax-tag-name | tag name | tag name | 12.1.2
syntax-tag-omission | omitted | omitted | 12.1.2.4
syntax-tags | Tags | Tags | 12.1.2
syntax-text | Text | Text | 12.1.3
tabindex focus flag | tabindex focus flag | tabindex focus flag | 6.4.3
table model | table model | table model | 4.9.12
table model error | table model error | table model error | 4.9.12
table-created | table-created | table-created | 4.9.1
take pending play promises | take pending play promises | take pending play promises | 4.8.12.8
target element | target element | target element | 7.8.9
task queue | task queues | task queues | 8.1.4.1
task source | task source | task source | 8.1.4.1
telephone type strings | telephone type strings | telephone type strings | 5.3.1
template contents | template contents | template contents | 4.12.3
temporary buffer | temporary buffer | temporary buffer | 12.2.4
terminate a worker | terminate a worker | terminate a worker | 10.2.4
termination nesting level | termination nesting level | termination nesting level | 7.8.11
text content | Text | Text | 3.2.5.2.5
text preparation algorithm | text preparation algorithm | text preparation algorithm | 4.12.5.1.4
text track | text tracks | text tracks | 4.8.12.11.1
text track cue | text track cue | text track cue | 4.8.12.11.1
text track cue active flag | active flag | active flag | 4.8.12.11.1
text track cue display state | display state | display state | 4.8.12.11.1
text track cue end time | An end time | An end time | 4.8.12.11.1
text track cue identifier | An identifier | An identifier | 4.8.12.11.1
text track cue order | text track cue order | text track cue order | 4.8.12.11.1
text track cue pause-on-exit flag | A pause-on-exit flag | A pause-on-exit flag | 4.8.12.11.1
text track cue start time | A start time | A start time | 4.8.12.11.1
text track cue writing direction | text track cue writing direction | text track cue writing direction | 2.1.8
text track disabled | Disabled | Disabled | 4.8.12.11.1
text track failed to load | Failed to load | Failed to load | 4.8.12.11.1
text track hidden | Hidden | Hidden | 4.8.12.11.1
text track in-band metadata track dispatch type | An in-band metadata track dispatch type | An in-band metadata track dispatch type | 4.8.12.11.1
text track kind | The kind of text track | The kind of text track | 4.8.12.11.1
text track label | A label | A label | 4.8.12.11.1
text track language | A language | A language | 4.8.12.11.1
text track list of cues | A list of zero or more cues | A list of zero or more cues | 4.8.12.11.1
text track loaded | Loaded | Loaded | 4.8.12.11.1
text track loading | Loading | Loading | 4.8.12.11.1
text track mode | A mode | A mode | 4.8.12.11.1
text track not loaded | Not loaded | Not loaded | 4.8.12.11.1
text track readiness state | A readiness state | A readiness state | 4.8.12.11.1
text track rules for extracting the chapter title | Rules for extracting the chapter title | Rules for extracting the chapter title | 4.8.12.11.1
text track showing | Showing | Showing | 4.8.12.11.1
textarea effective height | textarea effective height | textarea effective height | 14.5.15
textarea effective width | textarea effective width | textarea effective width | 14.5.15
textarea line break normalization transformation | textarea line break normalization transformation | textarea line break normalization transformation | 4.10.11
textarea wrapping transformation | textarea wrapping transformation | textarea wrapping transformation | 4.10.11
the link is an alternative stylesheet | the link is an alternative stylesheet | the link is an alternative stylesheet | 4.6.6.18
the outline's owner | the outline's owner | the outline's owner | 4.3.11.1
the properties of an item | the properties of an item | the properties of an item | 5.2.5
the script is ready | the script is ready | the script is ready | 4.12.1.1
the text tracks are ready | ready | ready | 4.8.12.11.1
the worker's ports | the worker's ports | the worker's ports | 10.2.3
the worker's workers | the worker's workers | the worker's workers | 10.2.3
the-hostensurecancompilestrings-implementation | HostEnsureCanCompileStrings | HostEnsureCanCompileStrings | 8.1.3.11
throw | throw | throw | 2.1.8
throw-on-dynamic-markup-insertion counter | throw-on-dynamic-markup-insertion counter | throw-on-dynamic-markup-insertion counter | 8.4
time marches on | time marches on | time marches on | 4.8.12.8
timeline offset | timeline offset | timeline offset | 4.8.12.6
timer initialization steps | timer initialization steps | timer initialization steps | 8.5
timer nesting level | timer nesting level | timer nesting level | 8.5
timer task source | timer task source | timer task source | 8.5
toolbar state | toolbar | toolbar | 4.11.3
top layer | top layer | top layer | 2.1.8
top-layer-add | add | add | 2.1.8
top-layer-remove | remove | remove | 2.1.8
top-level browsing context | top-level browsing context | top-level browsing context | 7.1.1
top-level microdata items | top-level microdata item | top-level microdata item | 5.2.5
topmost script-having execution context | topmost script-having execution context | topmost script-having execution context | 8.1.3.5.2
trace a path | trace a path | trace a path | 4.12.5.1.3
track URL | track URL | track URL | 4.8.11
track label | track label | track label | 4.8.11
track language | track language | track language | 4.8.11
transfer-abstract-op | Transfer | Transfer | 2.7.6
translatable attributes | translatable attributes | translatable attributes | 3.2.6.3
translate-enabled | translate-enabled | translate-enabled | 3.2.6.3
translation mode | translation mode | translation mode | 3.2.6.3
transparent | transparent | transparent | 3.2.5.3
traverse the history | traverse the history | traverse the history | 7.8.10
traverse the history by a delta | traverse the history by a delta | traverse the history by a delta | 7.7.2
tree | tree | tree | 2.1.8
tree construction dispatcher | tree construction dispatcher | tree construction dispatcher | 12.2.5
tree order | tree order | tree order | 2.1.8
triggered by user activation | triggered by user activation | triggered by user activation | 6.3
type blocklist | type blocklist | type blocklist | 8.7.1.3
type selector | type selector | type selector | 2.1.8
typed item | typed item | typed item | 5.2.2
unfocusing steps | unfocusing steps | unfocusing steps | 6.4.4
uninstantiated inclusive descendant module scripts | uninstantiated inclusive descendant module scripts | uninstantiated inclusive descendant module scripts | 8.1.3.2
unit of related browsing contexts | unit of related browsing contexts | unit of related browsing contexts | 7.1.4
unit of related similar-origin browsing contexts | unit of related similar-origin browsing contexts | unit of related similar-origin browsing contexts | 7.1.4
unload a document | unload a document | unload a document | 7.8.11
unloading document cleanup steps | unloading document cleanup steps | unloading document cleanup steps | 7.8.11
unloading document visibility change steps | unloading document visibility change steps | unloading document visibility change steps | 7.8.11
unordered set of unique space-separated tokens | unordered set of unique space-separated tokens | unordered set of unique space-separated tokens | 2.3.7
unsafe response | unsafe response | unsafe response | 2.5.1
unsafe-request flag | unsafe-request flag | unsafe-request flag | 2.1.8
unshipped port message queue | unshipped port message queue | unshipped port message queue | 9.5.3
unstyled document | unstyled document | unstyled document | 14.9
update the image data | update the image data | update the image data | 4.8.4.3.4
update the session history with the new page | update the session history with the new page | update the session history with the new page | 7.8.1
update the source set | update the source set | update the source set | 4.8.4.3.6
upgrade reaction | upgrade reaction | upgrade reaction | 4.13.6
upgrade the pending request to the current request | upgrade the pending request to the current request | upgrade the pending request to the current request | 4.8.4.3.4
uppercase ASCII hex digits | uppercase ASCII hex digits | uppercase ASCII hex digits | 2.3.1
uppercase ASCII letters | uppercase ASCII letters | uppercase ASCII letters | 2.3.1
use-URL-credentials flag | use-URL-credentials flag | use-URL-credentials flag | 2.1.8
used microdata items | used microdata item | used microdata item | 5.2.5
used value | used value | used value | 2.1.8
user interaction task source | user interaction task source | user interaction task source | 8.1.4.3
using the rules for | using the rules for | using the rules for | 12.2.3.1
valid MIME type | valid MIME type | valid MIME type | 2.1.8
valid MIME type with no parameters | valid MIME type with no parameters | valid MIME type with no parameters | 2.1.8
valid URL | valid URL | valid URL | 2.4.1
valid URL potentially surrounded by spaces | valid URL potentially surrounded by spaces | valid URL potentially surrounded by spaces | 2.4.1
valid browsing context name | valid browsing context name | valid browsing context name | 7.1.5
valid browsing context name or keyword | valid browsing context name or keyword | valid browsing context name or keyword | 7.1.5
valid custom element name | valid custom element name | valid custom element name | 4.13.3
valid date string | valid date string | valid date string | 2.3.5.2
valid date string with optional time | valid date string with optional time | valid date string with optional time | 2.3.5.10
valid duration string | valid duration string | valid duration string | 2.3.5.9
valid e-mail address | valid e-mail address | valid e-mail address | 4.10.5.1.5
valid e-mail address list | valid e-mail address list | valid e-mail address list | 4.10.5.1.5
valid floating-point number | valid floating-point number | valid floating-point number | 2.3.4.3
valid global date and time string | valid global date and time string | valid global date and time string | 2.3.5.7
valid hash-name reference | valid hash-name reference | valid hash-name reference | 2.3.9
valid integer | valid integer | valid integer | 2.3.4.1
valid list of floating-point numbers | valid list of floating-point numbers | valid list of floating-point numbers | 2.3.4.6
valid local date and time string | valid local date and time string | valid local date and time string | 2.3.5.5
valid lowercase simple color | valid lowercase simple color | valid lowercase simple color | 2.3.6
valid media query list | valid media query list | valid media query list | 2.3.10
valid month string | valid month string | valid month string | 2.3.5.1
valid non-empty URL | valid non-empty URL | valid non-empty URL | 2.4.1
valid non-empty URL potentially surrounded by spaces | valid non-empty URL potentially surrounded by spaces | valid non-empty URL potentially surrounded by spaces | 2.4.1
valid non-negative integer | valid non-negative integer | valid non-negative integer | 2.3.4.2
valid normalized local date and time string | valid normalized local date and time string | valid normalized local date and time string | 2.3.5.5
valid simple color | valid simple color | valid simple color | 2.3.6
valid source size list | valid source size list | valid source size list | 4.8.4.2.2
valid time string | valid time string | valid time string | 2.3.5.4
valid time-zone offset string | valid time-zone offset string | valid time-zone offset string | 2.3.5.6
valid vevent duration string | valid vevent duration string | valid vevent duration string | 5.3.2
valid week string | valid week string | valid week string | 2.3.5.8
valid yearless date string | valid yearless date string | valid yearless date string | 2.3.5.3
validity states | validity states | validity states | 4.10.21.1
value sanitization algorithm | value sanitization algorithm | value sanitization algorithm | 4.10.5
viewport | viewport | viewport | 2.1.8
viewport-based selection | viewport-based selection | viewport-based selection | 4.8.4.1
visible | visible | visible | 2.1
week number of the last day | week number of the last day | week number of the last day | 2.3.5.8
when shadows are drawn | Shadows are only drawn if | Shadows are only drawn if | 4.12.5.1.18
when-defined promise map | when-defined promise map | when-defined promise map | 4.13.4
width descriptor | width descriptor | width descriptor | 4.8.4.2.1
width descriptor value | width descriptor value | width descriptor value | 4.8.4.2.1
willful violation | willful violation | willful violation | 1.7.2
x \n x | x \n x | x \n x | 4.5.8
x-this | this | this | 1.9.2
x-user-defined | x-user-defined | x-user-defined | 12.2.2.3
